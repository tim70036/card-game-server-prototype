...
func (api *LocalGameAPI) FetchGameSetting() (*txpokerapi.GameSettingResponse, error) {
	return &txpokerapi.GameSettingResponse{
...
func (api *LocalGameAPI) FetchRoom(roomId string, gameMetaUid string) (*txpokerapi.RoomResponse, error) {
...
func (api *LocalGameAPI) FetchGameResult(gameId string) (*txpokerapi.GameResultResponse, error) {
	return &txpokerapi.GameResultResponse{
		Data: lo.Map(
...
func (api *LocalGameAPI) TriggerJackpot(jackpotPlayers []*model2.Player, gameMetaUid string) (*txpokerapi.TriggerJackpotResponse, error) {
