...
type ChatServiceClient interface {
	...
	Send(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *chatServiceClient) Subscribe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (ChatService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/common.ChatService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatServiceClient) Send(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/common.ChatService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	Send(context.Context, *ChatRequest) (*emptypb.Empty, error)
...
func (UnimplementedChatServiceServer) Send(context.Context, *ChatRequest) (*emptypb.Empty, error) {
...
func _ChatService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.ChatService/Send",
	}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "common.ChatService",
	...
	Metadata: "common/chat_service.proto",
}
